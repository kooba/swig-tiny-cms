...
exports.initialize = function (swig, app, options) {
  ...
  app.use(inject({
    snippet: "<link href='https://raw.githubusercontent.com/IanLunn/Hover/master/css/hover.css' rel='stylesheet'>"
  }));
  ...
  swig.setExtension('preContent', function (fileId) {
    ...
    if (admin) {
      var adminPreContent = "<div style='border: 1px solid black'><a class='button grow' href='/"  + swigCmsOptions.route + "/edit/"
        + fileId + "?returnUrl=" + request.url + "'>Edit</a>";
