...
exports.initialize = function (swig, app, options) {
  ...
  app.use(inject({
    snippet: "<style> .swig-cms-div>.swig-cms-edit{visibility:hidden;opacity:0;transition:visibility 0s linear .5s,opacity .5s linear}.swig-cms-div:hover>.swig-cms-edit{visibility:visible;opacity:1;transition-delay:0s}.swig-cms-edit{padding:2px;position:absolute;width:auto}.swig-cms-edit a{color:cornflowerblue}.swig-cms-edit-inner{padding:5px;text-align:center;background-color:#ffffff;width:30px;float:right;font-family:arial,sans-serif;font-size:8pt;border:1px inset cornflowerblue;border-radius:4px}</style>"
  }));
